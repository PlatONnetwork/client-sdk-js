...
var tests = [
    ...
    },
    {
        useLocalWallet: function (web3) {
            web3.platon.accounts.wallet.add('0xd7d364e720c129acb940439a84a99185dd55af6f6d105018a8acfb7f8c008142');
        },
    ...
    {
        useLocalWallet: function (web3) {
            web3.platon.accounts.wallet.add('0xf7d364e720c129acb940439a84a99185dd55af6f6d105018a8acfb7f8c008142');
        },
    ...
    tests.forEach(function (test, index) {
        it('promise test: ' + index, function (done) {
            ...
            if (test.error) {
                ...
                result = web3.platon[method].apply(web3, args);
        ...
        it('callback test: ' + index, function (done) {
            ...
            if (test.error) {
                ...
                web3.platon[method].apply(web3, args);
            }
        });
    });
});
