...
大家可以使用`npm run pw3`或`npm run pw3-min`来构建自己的本地文件，也可以通过jsdelivr使用本项目已经打包完成的文件。如https://cdn.jsdelivr.net/gh/RileyGe/client-sdk-js@0.11.2/dist/web3a.js 或https://cdn.jsdelivr.net/gh/RileyGe/client-sdk-js@0.11.2/dist/web3a.min.js
